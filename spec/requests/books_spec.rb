...
describe "Books API", type: :request do
  ...
  describe "Get /books" do
    before do
      FactoryBot.create(:book, title: '1884', author: first_author)
    ...
    it 'returns a subset of books based on pagination(limit)' do
    ...
    it 'returns a subset of books based on pagination(limit and offset)' do
  ...
  describe "DELETE /books/:id" do
    let!(:book) { FactoryBot.create(:book, title: '1884', author: first_author) }

    it 'deleted a new book' do
      expect {
